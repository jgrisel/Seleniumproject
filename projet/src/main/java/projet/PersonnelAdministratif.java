...
public class PersonnelAdministratif extends Personne implements EmployeEcole {
	...
	static org.slf4j.Logger logger = LoggerFactory.getLogger(PersonnelAdministratif.class);
	
public PersonnelAdministratif (String nom, String prenom, String po) {
		super(nom, prenom);
		poste=po;
}
...
public void demanderAugmentation() {
	if (nb_absences_mois_en_cours <= 4) {
		Ecole.augmenterSalairePersoAdmin(this, salaire);
